...
class ReporteMensajesFragment : Fragment(), ReportesListener, FiltroReportesDialog.FiltroReportesDialogListener {
    ...
    private var enviadosB: Int = 0
    private var recibidosB: Int = 0
    ...
    private fun graficabarrasBroadcastGrupal(listaUsuarios: ArrayList<UserMessageDetailReport>) {
        ...
        binding.txtSegundoLegend.text = reporteMensajesViewModel.enviadosB.value.toString()

        binding.txtCuartoLegend.text = reporteMensajesViewModel.recibidosB.value.toString()
